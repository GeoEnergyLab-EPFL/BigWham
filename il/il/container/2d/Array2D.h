...
class Array2D {
  ...
  */
  ...
  public:
    ...
    ArrayView<T> operator[] (int i) const { return ArrayView(data + i*n0, n0); }
    const_iterator operator+(int i) const { return const_iterator(data + i*n0, n0); }
    const_iterator operator-(int i) const { return const_iterator(data - i*n0, n0); }

    ArrayView<T> operator*() const { return ArrayView(data, n0); }
    bool operator==(const const_iterator & other) const { return (data == other.data and n0 == other.n0); }
    bool operator!=(const const_iterator & other) const { return (not this->operator==(other)); }
...
//  iterator begin();
  ...
  const_iterator end() const  { return const_iterator(data_ + size_[0]*size_[1], size_[0]); }
  const_iterator cbegin() const  { return const_iterator(data_, size_[0]); }
  const_iterator cend() const { return const_iterator(data_ + size_[0]*size_[1], size_[0]); }
