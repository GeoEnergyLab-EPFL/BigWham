...
s_integral_gen(const int ker, double poiss_r, std::complex<double> eix,
...
s_integral_lim(const int ker, double poiss_r, std::complex<double> eix,
...
il::Array2D<double> traction_influence_3DT6(bie::FaceData &elem_data_s,
                                            bie::FaceData &elem_data_r,
                                            il::int_t n_s, il::int_t n_t,
